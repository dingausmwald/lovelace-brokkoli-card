          ...
          <form @submit=${this.createPlant}>
            ...
            <div class="form-field">
              ...
              <select id="growth_phase" name="growth_phase" required>
                ...
                <option value="growing">${a.TranslationUtils.translateGrowthPhase(this.hass,"growing")}</option>
